...
V13_OOF = 0.5631
V13_HOLD = 0.5703
WIN_OOF_STRICT = 0.670
WIN_HOLD_STRICT = 0.631
...
def main():
    ...
    if "kd" in P and "kd2" in P:
        ...
        # v18: exhaustive KD-only multi-blends (eq/pow/conf) on all available KD
    ...
    metrics = {
        ...
        "v17_nested_oof": V17_OOF, "v17_holdout": V17_HOLD, "v16_nested_oof": V16_OOF, "v16_holdout": V16_HOLD, "v15_nested_oof": V15_OOF, "v15_holdout": V15_HOLD,
