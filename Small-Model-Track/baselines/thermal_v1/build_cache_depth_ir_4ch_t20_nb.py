"""4ch T=20: subsample non-IR-box native-style T24 Depth+IR. Unused T+crop."""
...
SRC = ROOT / "cache" / "depth_ir_4ch_t24_noirbox"
OUT = ROOT / "cache" / "depth_ir_4ch_t20_nb"
...
def main():
    ...
    info = {
        "arch_input": "non-IR-box Depth RGB + IR gray, T=20 subsample of T24 noirbox",
