...
def main():
    ...
    assert hold["best"]["kind"] == "avg_v44_v36_on_v40"
    ...
    passed = bool(
        ...
        and not banned_hit and keep_ok and hold["best"]["n"] >= 1
    )
    print(f"kind=avg_v44_v36_on_v40 spec={SPEC} wc={cfg['wc']}", flush=True)
