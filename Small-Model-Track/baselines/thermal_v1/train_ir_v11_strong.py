"""v11 IR strong v11: Kinetics R(2+1)D-18 mixup on IR YOLO-v4 crops (new seeds).
...
def main():
    ...
    ap.add_argument("--ckpt-dir", default=str(ROOT / "checkpoints" / "ir_yolo_r2p1d18_v11"))
    ...
    ap.add_argument("--seeds", type=int, nargs="+", default=[888, 2025, 314])
    ap.add_argument("--mixup", type=float, default=0.25)
    ...
    (ckpt_dir / "metrics_ir_strong_v11.json").write_text(json.dumps(metrics, indent=2))
