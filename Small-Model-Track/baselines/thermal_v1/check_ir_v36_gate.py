"""In-repo gate for ir_v36 noirbox-FT 4ch ranked-prefix. Imports shipped nested_fixed/apply_cfg."""
...
from write_ir_v36_noirbox_ft import (
    CFG, MAX_DIS, MISSED_CLIP, ROOT, U24_MIN, U8_MIN, V29B_CSV, V29B_NESTED,
    deploy_pack_mb, evaluate_v36_hold, write_v36_submission,
)
