"""ir_v19 IR diversity: Kinetics MC3-18 on IR YOLO-v4 crops (non-R2+1D).
MC3 packs ~23MB fp16 + YOLO ~6.5MB << 100MB. Complementary to classic9 R(2+1)D BASE.
"""
...
def build(pretrained=True):
    m = mc3_18(weights=MC3_18_Weights.KINETICS400_V1 if pretrained else None)
...
def main():
    ...
    ap.add_argument("--ckpt-dir", default=str(ROOT / "checkpoints" / "ir_yolo_mc3_18_v19"))
