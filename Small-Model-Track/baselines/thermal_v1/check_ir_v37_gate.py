"""In-repo gate for ir_v37 native T24 FT 4ch ranked-prefix. Imports shipped nested_fixed/apply_cfg."""
...
from write_ir_v37_t24_ft import (
    CFG, MAX_DIS, MISSED_CLIP, ROOT, U24_MIN, U8_MIN, V29B_CSV, V29B_NESTED, V36_CSV,
    deploy_pack_mb, evaluate_v37_hold, write_v37_submission,
)
...
def main():
    ...
    print(f"hold_dis_v29b={hold_dis} file_dis_v29b={file_dis} file_dis_v36={file_dis_v36} only_0379={int(only_0379)} file_dis_v36_ge2={int(file_dis_v36 >= 2)}", flush=True)
