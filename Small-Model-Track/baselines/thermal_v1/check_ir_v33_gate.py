"""In-repo gate for ir_v33 T24 4ch ranked-prefix. Imports shipped nested_fixed/apply_cfg."""
...
from write_ir_v33_t24 import (
    CFG, MAX_DIS, MISSED_CLIP, ROOT, U24_MIN, U8_MIN, V29B_CSV, V29B_NESTED,
    deploy_pack_mb, evaluate_v33_hold, write_v33_submission,
)
