"""In-repo gate for ir_v35 native T24 4ch ranked-prefix. Imports shipped nested_fixed/apply_cfg."""
...
from write_ir_v35_t24n import (
    CFG, MAX_DIS, MISSED_CLIP, ROOT, U24_MIN, U8_MIN, V29B_CSV, V29B_NESTED,
    deploy_pack_mb, evaluate_v35_hold, write_v35_submission,
)
